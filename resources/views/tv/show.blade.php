    ...
    {{-- Movie Info --}}
        <div class="movie-info border-b border-gray-800">
            <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                <img src="{{ $tvShow['poster_path'] }}" alt="Poster" class="mx-auto w-64 md:w-80 lg:w-96">
                        ...
                        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    ...
                                    <iframe width="560" height="315" class="responsive-iframe absolute top-0 left-0 w-full h-full" src="{{ $trailer['id'] }}" allow="autoplay; encrypted-media" allowfullscreen frameborder="0"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container mx-auto px-4 py-16">
                ...
                <div class="grid gap-20 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    @foreach ($casts as $cast)
                        <div class="mt-8">
                            <a href="{{ route('actor.detail', ['id' => $cast['id']]) }}"><img src="{{ $cast['profile_path'] }}" alt="Cast" class="hover:opacity-75 transition ease-in-out duration-200"></a>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-10 mt-8">
                    ...
                    {{-- .prevent = agar tidak langsung terbuka --}}
                        <a 
                            @click.prevent="
                            isOpen=true
                            image='{{ $image['file_path'] }}' " href="#" @click="isOpen = true"><img src="{{ $image['file_path'] }}" alt="Gambar"></a>
                    @endforeach
                </div>
            </div>
