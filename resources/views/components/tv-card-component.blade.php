<div class="mt-8">
    <a href="{{ route('tv.show', ['id' => $tv['id']]) }}"><img src="{{ $tv['poster_path'] }}" alt="Poster" class="hover:opacity-75 transition ease-in-out duration-200"></a>
    <div class="mt-2">
        <a href="{{ route('tv.show', ['id' => $tv['id']]) }}" class="text-lg mt-2 hover:text-gray-300">{{ $tv['name'] }}</a>
    </div> 
